    ...
    return [
        ...
        [
            InlineKeyboardButton(
                ...
                url="https://t.me/TheSirionBot?startgroup=true"
            )
        ],
        [
            InlineKeyboardButton(text="𝐂ʜᴀᴛʙᴏᴛ", url="https://t.me/SHREYAMACHINEBOT"),
            InlineKeyboardButton(text="𝐌ᴀɴᴀɢᴇʀ", url="https://t.me/tseries_musicbot"),
        ],
    ]
